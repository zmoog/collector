...
replace github.com/zmoog/collector/receiver/wavinsentioreceiver v0.0.0 => ../receiver/wavinsentioreceiver

replace github.com/zmoog/collector/receiver/zcsazzurroreceiver v0.0.0 => ../receiver/zcsazzurroreceiver